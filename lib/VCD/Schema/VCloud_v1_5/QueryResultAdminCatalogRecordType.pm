package VCD::Schema::VCloud_v1_5::QueryResultAdminCatalogRecordType;
...
has_xml_attr 'numberOfTemplates' => (is => 'ro', xml_name => 'numberOfTemplates', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
...
Represents the results from a AdminCatalog vCloud query as a record.
