package VCD::Schema::VCloud_v1_5::QueryResultAdminTaskRecordType;
...
has_xml_attr 'cellName' => (is => 'ro', xml_name => 'cellName', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
...
Represents the results from a AdminTask vCloud query as a record.
