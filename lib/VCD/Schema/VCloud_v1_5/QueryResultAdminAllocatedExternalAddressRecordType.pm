package VCD::Schema::VCloud_v1_5::QueryResultAdminAllocatedExternalAddressRecordType;
...
Represents the results from a AdminAllocatedExternalAddress vCloud query as
a record.
