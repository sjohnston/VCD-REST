package VCD::Schema::VCloud_v1_5::VAppNetworkConfigurationType;
...
has_xml 'Configuration' => (is => 'rw', isa => 'Maybe[VCD::Schema::VCloud_v1_5::NetworkConfigurationType]', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
