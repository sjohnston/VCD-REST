...
has_xml 'GuestCustomizationSection' => (is => 'rw', isa => 'Maybe[VCD::Schema::VCloud_v1_5::GuestCustomizationSectionType]', xml_maximum => '1', xml_minimum => '0', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
