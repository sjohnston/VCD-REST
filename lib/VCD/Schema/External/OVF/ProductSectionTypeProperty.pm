package VCD::Schema::External::OVF::ProductSectionTypeProperty;
...
has_xml 'Label' => (is => 'rw', isa => 'Maybe[VCD::Schema::External::OVF::MsgType]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
...
has_xml 'Value' => (is => 'rw', isa => 'ArrayRef[VCD::Schema::External::OVF::PropertyConfigurationValueType]', xml_maximum => 'unbounded', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
