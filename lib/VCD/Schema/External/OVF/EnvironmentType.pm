package VCD::Schema::External::OVF::EnvironmentType;
...
has_xml 'Entity' => (is => 'rw', isa => 'ArrayRef[VCD::Schema::External::OVF::EntityType]', xml_maximum => 'unbounded', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/environment/1');
