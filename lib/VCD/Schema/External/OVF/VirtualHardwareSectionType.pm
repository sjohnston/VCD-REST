package VCD::Schema::External::OVF::VirtualHardwareSectionType;
...
has_xml 'System' => (is => 'rw', isa => 'Maybe[VCD::Schema::External::OVF::VSSDType]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
