...
our $map = {
    '1.5' => {
        ...
        'application/vnd.vmware.vcloud.rasdItem+xml' => 'VCD::Schema::External::OVF::RASD_Type',
        ...
        'application/vnd.vmware.admin.network+xml' => 'VCD::Schema::VCloud_v1_5::OrgNetworkType',
        ...
        'application/vnd.vmware.vcloud.virtualHardwareSection+xml' => 'VCD::Schema::External::OVF::VirtualHardwareSection_Type',
        ...
        'application/vnd.vmware.vcloud.operatingSystemSection+xml' => 'VCD::Schema::External::OVF::OperatingSystemSection_Type',
        ...
        'application/vnd.vmware.vcloud.networkSection+xml' => 'VCD::Schema::External::OVF::NetworkSection_Type',
        ...
        'application/vnd.vmware.vcloud.startupSection+xml' => 'VCD::Schema::External::OVF::StartupSection_Type',
