...
has_xml 'NetworkConfig' => (is => 'rw', isa => 'ArrayRef[VCD::VCloud_1_5::VAppNetworkConfigurationType]', xml_maximum => 'unbounded', xml_minimum => '0', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
