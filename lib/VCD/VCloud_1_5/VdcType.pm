package VCD::VCloud_1_5::VdcType;
...
has_xml 'AllocationModel' => (is => 'rw', isa => 'Str', namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'StorageCapacity' => (is => 'rw', isa => 'VCD::VCloud_1_5::CapacityWithUsageType', namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'ComputeCapacity' => (is => 'rw', isa => 'VCD::VCloud_1_5::ComputeCapacityType', namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'ResourceEntities' => (is => 'ro', isa => 'VCD::VCloud_1_5::ResourceEntitiesType', namespace => 'http://www.vmware.com/vcloud/v1.5');
...
has_xml 'NicQuota' => (is => 'rw', isa => 'Str', namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'NetworkQuota' => (is => 'rw', isa => 'Str', namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'VmQuota' => (is => 'rw', isa => 'Str', namespace => 'http://www.vmware.com/vcloud/v1.5');
