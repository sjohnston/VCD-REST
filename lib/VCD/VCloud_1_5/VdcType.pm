...
has_xml 'StorageCapacity' => (is => 'rw', isa => 'Maybe[VCD::VCloud_1_5::CapacityWithUsageType]', xml_maximum => '1', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
has_xml 'ComputeCapacity' => (is => 'rw', isa => 'Maybe[VCD::VCloud_1_5::ComputeCapacityType]', xml_maximum => '1', xml_minimum => '1', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
...
use VCD::VCloud_1_5::ComputeCapacityType;
