...
has_xml 'CustomOrgLdapSettings' => (is => 'rw', isa => 'Maybe[VCD::VCloud_1_5::CustomOrgLdapSettingsType]', xml_maximum => '1', xml_minimum => '0', xml_namespace => 'http://www.vmware.com/vcloud/v1.5');
