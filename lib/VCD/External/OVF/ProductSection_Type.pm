...
has_xml 'Version' => (is => 'rw', isa => 'Maybe[VCD::External::OVF::cimString]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
has_xml 'FullVersion' => (is => 'rw', isa => 'Maybe[VCD::External::OVF::cimString]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
has_xml 'ProductUrl' => (is => 'rw', isa => 'Maybe[VCD::External::OVF::cimString]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
has_xml 'VendorUrl' => (is => 'rw', isa => 'Maybe[VCD::External::OVF::cimString]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
has_xml 'AppUrl' => (is => 'rw', isa => 'Maybe[VCD::External::OVF::cimString]', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/envelope/1');
...
use VCD::External::OVF::cimString;
