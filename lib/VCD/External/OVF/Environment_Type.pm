package VCD::External::OVF::Environment_Type;
...
has_xml 'Entity' => (is => 'rw', isa => 'ArrayRef[VCD::External::OVF::Entity_Type]', xml_maximum => 'unbounded', xml_minimum => '0', xml_namespace => 'http://schemas.dmtf.org/ovf/environment/1');

use VCD::External::OVF::Entity_Type;
